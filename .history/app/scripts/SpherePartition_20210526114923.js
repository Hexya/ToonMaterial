...
export default class App {
    ...
    render(bloomPass) {
        ...
        for(var i=0;i<1;i++) {
            ...
            this.torus.rotation.x += 0.01 - 0.05;
            this.torus.rotation.y += 0.03 - 0.05;
            this.torus.rotation.z += 0.02 - 0.05;

            this.torusS.rotation.x += 0.03 - 0.05;
            this.torusS.rotation.y += 0.02 - 0.05;
            this.torusS.rotation.z += 0.01 - 0.05;

            this.torusM.rotation.x += 0.02 - 0.05;
            this.torusM.rotation.y -= 0.02 - 0.05;
            this.torusM.rotation.z += 0.03 - 0.05;
