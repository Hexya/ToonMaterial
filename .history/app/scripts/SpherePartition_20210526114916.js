...
export default class App {
    ...
    constructor() {
        ...
        let matTorus = new THREE.MeshToonMaterial({color:0xcdab0d,metalness:1});
        this.torus = new THREE.Mesh( geoTorus, matTorus );
        this.scene.add(this.torus)

        let geoTorusM = new THREE.TorusGeometry( 0.095, 0.003, 30,80 );
        let matTorusM = new THREE.MeshToonMaterial({color:0x00ff00,metalness:1});
        this.torusM = new THREE.Mesh( geoTorusM, matTorusM );
        this.scene.add(this.torusM)

        let geoTorusS = new THREE.TorusKnotGeometry( 0.2, 0.025, 200,150 );
        let matTorusS = new THREE.MeshToonMaterial({color:0xcd720d,metalness:1});
    ...
    render(bloomPass) {
        ...
        for(var i=0;i<1;i++) {
            ...
            this.torus.rotation.x += 0.01 - 0.01;
            this.torus.rotation.y += 0.03 - 0.01;
            this.torus.rotation.z += 0.02 - 0.01;

            this.torusS.rotation.x += 0.03 - 0.01;
            this.torusS.rotation.y += 0.02 - 0.01;
            this.torusS.rotation.z += 0.01 - 0.01;

            this.torusM.rotation.x += 0.02 - 0.01;
            this.torusM.rotation.y -= 0.02 - 0.01;
            this.torusM.rotation.z += 0.03 - 0.01;
