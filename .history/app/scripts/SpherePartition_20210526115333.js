...
export default class App {
    ...
    constructor() {
        ...
        //TORUS
        let geoTorus = new THREE.TorusKnotGeometry( 0.1, 0.002, 130,80 );
        let matTorus = new THREE.MeshToonMaterial({color:0xff00ff,gradientMap:"threeTone"});
        this.torus = new THREE.Mesh( geoTorus, matTorus );
        this.scene.add(this.torus)

        let geoTorusM = new THREE.TorusKnotGeometry( 0.095, 0.003, 30,80 );
        let matTorusM = new THREE.MeshToonMaterial({color:0xffff00,gradientMap:"threeTone"});
        ...
        let matTorusS = new THREE.MeshToonMaterial({color:0x00ffff,gradientMap:"threeTone"});
