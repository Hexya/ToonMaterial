...
export default class App {
    ...
    constructor() {
        ...
        let matTorus = new THREE.MeshToonMaterial({color:0xff00ff, gradientMap: "fiveTone"});
        this.torus = new THREE.Mesh( geoTorus, matTorus );
        this.scene.add(this.torus)

        let geoTorusM = new THREE.TorusKnotGeometry( 0.095, 0.003, 30,80 );
        let matTorusM = new THREE.MeshToonMaterial({color:0xffff00, gradientMap: "fiveTone"});
        ...
        let matTorusS = new THREE.MeshToonMaterial({color:0x00ffff, gradientMap: "fiveTone"});
