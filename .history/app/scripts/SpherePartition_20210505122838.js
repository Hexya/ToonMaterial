...
import { TweenMax, TimelineMax,TweenLite, TimelineLite } from "gsap"; // Also works with TweenLite and TimelineLite
import { ScrollMagicPluginGsap } from "scrollmagic-plugin-gsap";
...
export default class App {
    ...
    constructor() {
        ...
        this.tl.from(".bloc", 0.5, {left:15, background: 'red'});
...
//         // var blockTween = TweenMax.to(".start-btn"), 1, {background: red};
...
//             offset: 50, // start this scene after scrolling for 50px
//         })
//         .setTween(".start-btn", 0.5, {backgroun: 'red'})
//         .addIndicators()
//         .addTo(controller);
