...
export default class App {
    ...
    render(bloomPass) {
        ...
        for(var i=0;i<1;i++) {
            ...
            this.torusS.rotation.x += 0.003;
            this.torusS.rotation.y += 0.002;
            this.torusS.rotation.z += 0.001;

            this.torusM.rotation.x += 0.002;
            this.torusM.rotation.y -= 0.002;
            this.torusM.rotation.z += 0.003;
