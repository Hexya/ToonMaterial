...
export default class App {
    ...
    constructor() {
        ...
        var blockTween = console.log('hola');
        ...
        .addIndicators()
        .addTo(controller);
        this.start = containerScene.scrollOffset();
        this.end = containerScene.scrollOffset() + containerScene.duration();

        controller.update();

// update the controller immediately
controller.update(true);    
        console.log("the scene starts at", this.start, "and ends at", this.end);
