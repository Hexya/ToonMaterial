...
export default class App {
    ...
    constructor() {
        ...
        var cubeGeometry = new THREE.TorusKnotBufferGeometry( 5, 1, 200, 100 );
        var cube = new THREE.Mesh( cubeGeometry, material );
        cube.position.set(30, 10, 20);
        this.scene.add( cube );
        
        var outlineMaterial2 = new THREE.MeshBasicMaterial( { color: 0x00ff00, side: THREE.BackSide } );
        var torusSO = new THREE.Mesh( geoTorusS, outlineMaterial2 );
        // torusSO.position.set(30, 10, 20)
        torusSO.scale.multiplyScalar(1.05);
        this.scene.add( torusSO );
